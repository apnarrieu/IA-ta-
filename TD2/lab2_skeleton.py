...
nn = Sequential()
nn.add(Dense(100, input_dim=num_pixels, kernel_initializer='normal', activation='sigmoid'))
nn.add(Dense(10, kernel_initializer='normal', activation='softmax'))
nn.compile(loss='categorical_crossentropy', optimizer='sgd', metrics=['accuracy'])
nn.summary()
nn.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=100, batch_size=100)
